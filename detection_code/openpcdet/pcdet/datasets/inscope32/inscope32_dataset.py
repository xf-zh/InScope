...
class InScope32Dataset(DatasetTemplate):
...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_mlsys32_infos':
        import yaml
        from pathlib import Path
        ...
        create_custom_infos(
            ...
            data_path=Path('/ai/data/MLSYS_32'),
            save_path=Path('/ai/data/MLSYS_32'),
        )
