...
class InScope80Dataset(DatasetTemplate):
    ...
    def evaluation(self, det_annos, class_names, **kwargs):
        ...
        def kitti_eval(eval_det_annos, eval_gt_annos, map_name_to_kitti):
            ...
            # print(eval_det_annos[5])
            # print(eval_gt_annos[5])
...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_mulsys80_infos':
        import yaml
        from pathlib import Path
        ...
        create_custom_infos(
            ...
            class_names=['Car', 'Pedestrian', 'Cyclist', 'Truck'],
             data_path=ROOT_DIR / 'data' / 'mulsys_80',
            save_path=ROOT_DIR / 'data' / 'mulsys_80',
        )
