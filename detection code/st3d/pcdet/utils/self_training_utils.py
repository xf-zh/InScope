...
def check_already_exsit_pseudo_label(ps_label_dir, start_epoch):
    ...
    # 因为我更改了PSEUDO_LABELS = {}为PSEUDO_LABELS = Manager().dict()，所以我需要更改这里的代码
    # init_ps_label = pkl.load(open(cfg.SELF_TRAIN.INIT_PS, 'rb'))会出现ConnectionRefusedError: [Errno 111] Connection refused的错误，所以我需要更改这里的代码
    #更改为下面的代码
