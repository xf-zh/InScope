...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_dair_infos':
        ...
        create_kitti_infos(
            ...
            class_names=['Car','Truck','Pedestrian', 'Cyclist','Van'],
            data_path=Path('/ai/data/lyn_code/OpenPCDet-master/data/single-infrastructure-side-kitti'),
            save_path=Path('/ai/data/lyn_code/OpenPCDet-master/data/single-infrastructure-side-kitti'),
        )
